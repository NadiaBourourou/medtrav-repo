...
public class ListHotels extends JFrame {
	...
	public ListHotels() {
		...
		comboBoxstars.setModel(new DefaultComboBoxModel(new String[] { "1",
				"2", "3", "4", "5" }));
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				byte[] image = HotelServicesDelegate.doGetMyImage(hotel
						.getHotelId());
	...
	protected void initDataBindings() {
		...
		//
		BeanProperty<Hotel, Double> hotelBeanProperty_6 = BeanProperty
				.create("priceSuite");
		jTableBinding.addColumnBinding(hotelBeanProperty_6).setColumnName(
				"Price for suite");
		//
		jTableBinding.bind();
		//
		...
		AutoBinding<Hotel, String, JTextField, String> autoBinding_7 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, hotel,
						hotelBeanProperty_7, name, jTextFieldBeanProperty);
		autoBinding_7.bind();
		//
		...
		AutoBinding<Hotel, String, JTextField, String> autoBinding_8 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, hotel,
						hotelBeanProperty_8, description,
						jTextFieldBeanProperty_1);
		autoBinding_8.bind();
		//
		BeanProperty<JTextField, String> jTextFieldBeanProperty_2 = BeanProperty
				.create("text");
		AutoBinding<Hotel, String, JTextField, String> autoBinding_9 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, hotel,
						hotelBeanProperty_11, address, jTextFieldBeanProperty_2);
		autoBinding_9.bind();
		//
		BeanProperty<JTextField, String> jTextFieldBeanProperty_3 = BeanProperty
				.create("text");
		AutoBinding<JTable, Double, JTextField, String> autoBinding_10 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
						jTableBeanProperty_5, pricesingle,
		...
		AutoBinding<Hotel, Double, JTextField, String> autoBinding_11 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, hotel,
						hotelBeanProperty_13, pricesuite,
						jTextFieldBeanProperty_4);
		autoBinding_11.bind();
		//
		BeanProperty<JComboBox, Object> jComboBoxBeanProperty = BeanProperty
				.create("selectedItem");
		AutoBinding<JTable, StateType, JComboBox, Object> autoBinding_12 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
						jTableBeanProperty_2, comboBoxstate,
						jComboBoxBeanProperty);
		autoBinding_12.bind();
		//
		AutoBinding<JTable, Integer, JComboBox, Object> autoBinding_13 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
