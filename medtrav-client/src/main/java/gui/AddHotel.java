...
public class AddHotel extends JFrame {
	...
	public AddHotel() {
		...
		btnNewButton.setIcon(new ImageIcon(AddHotel.class
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					hotel.setStars(new Integer(comboBox.getSelectedItem()
							.toString()));
					hotel.setState(StateType.valueOf(comboBox_1
		...
		lblNewLabel_4.setIcon(new ImageIcon(AddHotel.class
				.getResource("/images/hotel_icon4_tns.png")));

		JLabel label = new JLabel("");
		label.setIcon(new ImageIcon(AddHotel.class
