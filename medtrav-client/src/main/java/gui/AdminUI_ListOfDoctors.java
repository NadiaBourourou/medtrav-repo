...
public class AdminUI_ListOfDoctors extends JFrame {
	...
	public AdminUI_ListOfDoctors() {
		...
		btnBackToMenu.setIcon(new ImageIcon(AdminUI_ListOfDoctors.class
				.getResource("/images/Arrow-back.png")));
		...
		btnAddNewDoctor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				setVisible(false);
				AdminUI_AddDoctor back = new AdminUI_AddDoctor(user);
				back.setVisible(true);

			}
		});
		btnAddNewDoctor.setBackground(Color.WHITE);
		btnAddNewDoctor.setIcon(new ImageIcon(AdminUI_ListOfDoctors.class
		...
		button.setIcon(new ImageIcon(AdminUI_ListOfDoctors.class
				.getResource("/images/Search.png")));
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				doctors = UserServicesDelegate
						.doFindDoctorsBySpecialty(tfSearch.getText());
				initDataBindings();
			}
		});
		...
		lblLogo.setIcon(new ImageIcon(AdminUI_ListOfDoctors.class
		...
		gl_panel.setHorizontalGroup(gl_panel.createParallelGroup(
				...
				gl_panel.createSequentialGroup()
						...
						.addComponent(scrollPane, GroupLayout.DEFAULT_SIZE,
								633, Short.MAX_VALUE).addContainerGap()));
		...
		label.setIcon(new ImageIcon(AdminUI_ListOfDoctors.class
	...
	protected void initDataBindings() {
		...
		//
		BeanProperty<Doctor, Integer> doctorBeanProperty = BeanProperty
				.create("userId");
		...
		BeanProperty<Doctor, String> doctorBeanProperty_3 = BeanProperty
				.create("specialty");
		jTableBinding.addColumnBinding(doctorBeanProperty_3).setColumnName(
				"Specialty");
		//
		jTableBinding.bind();
	}
