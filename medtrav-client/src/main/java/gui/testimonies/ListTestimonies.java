...
public class ListTestimonies extends JFrame {
	...
	public ListTestimonies() {
		...
		table.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				int idTableau = (int) table.getValueAt(table.getSelectedRow(),
						3);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (user instanceof Patient) {
					...
					JOptionPane.showMessageDialog(null,
							"Sorry, as a doctor, you can't add a testimony.");
				} else if (user instanceof Administrator) {
					JOptionPane
							.showMessageDialog(null,
									"Sorry, as an administrator, you can't add a testimony.");
				} else {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					DisplayTestimony dispTestimony = new DisplayTestimony(
							testimonySelected);
		...
		searchtf.addKeyListener(new KeyAdapter() {
			...
			public void keyReleased(KeyEvent e) {
				if (rbtitle.isSelected()) {
					testimonies = TestimonyServicesDelegate
							.doFindAllTestimoniesByTitle(searchtf.getText());
				} else if (rbdescription.isSelected()) {
					testimonies = TestimonyServicesDelegate
							.doFindAllTestimoniesByPatientLastName(searchtf
									.getText());
				} else {
					System.out.println("rien de selectionné");
				}
				initDataBindings();
			}
		});
	...
	public ListTestimonies(User userConnected) {
		 ...
		 * System.out.println("USER="+youyou); Patient
		 * patientConnected=TestimonyServicesDelegate.doFindPatientById(2); int
		 * yoyo=patientConnected.getUserId();
		...
		btnAddANew.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				User user = TestimonyServicesDelegate
						.doFindUsertById(userConnected.getUserId());
				if (user instanceof Patient) {
					System.out.println("user is PATIENT");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					DisplayTestimony dispTestimony = new DisplayTestimony(
							testimonySelected, userConnected);
					dispTestimony.setLocationRelativeTo(null);
	...
	protected void initDataBindings() {
		JTableBinding<Testimony, List<Testimony>, JTable> jTableBinding = SwingBindings
				.createJTableBinding(UpdateStrategy.READ_WRITE, testimonies,
						table);
		//
		BeanProperty<Testimony, Integer> testimonyBeanProperty = BeanProperty
				.create("testimonyId");
		jTableBinding.addColumnBinding(testimonyBeanProperty).setColumnName(
				"Id testimony");
		//
		BeanProperty<Testimony, String> testimonyBeanProperty_1 = BeanProperty
				.create("title");
		jTableBinding.addColumnBinding(testimonyBeanProperty_1).setColumnName(
				"Title");
		//
		BeanProperty<Testimony, String> testimonyBeanProperty_2 = BeanProperty
				.create("description");
		jTableBinding.addColumnBinding(testimonyBeanProperty_2).setColumnName(
				"Description");
		//
		BeanProperty<Testimony, Integer> testimonyBeanProperty_3 = BeanProperty
				.create("patient.userId");
		jTableBinding.addColumnBinding(testimonyBeanProperty_3).setColumnName(
				"Id patient");
		//
		BeanProperty<Testimony, Date> testimonyBeanProperty_7 = BeanProperty
				.create("date");
		jTableBinding.addColumnBinding(testimonyBeanProperty_7).setColumnName(
				"Date");
		//
		jTableBinding.bind();
		//
		BeanProperty<JTable, Integer> jTableBeanProperty = BeanProperty
				.create("selectedElement.testimonyId");
		BeanProperty<Testimony, Integer> testimonyBeanProperty_4 = BeanProperty
				.create("testimonyId");
		AutoBinding<JTable, Integer, Testimony, Integer> autoBinding = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
						jTableBeanProperty, testimonySelected,
						testimonyBeanProperty_4);
		autoBinding.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_1 = BeanProperty
				.create("selectedElement.title");
		BeanProperty<Testimony, String> testimonyBeanProperty_5 = BeanProperty
				.create("title");
		AutoBinding<JTable, String, Testimony, String> autoBinding_1 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
						jTableBeanProperty_1, testimonySelected,
						testimonyBeanProperty_5);
		autoBinding_1.bind();
		//
		BeanProperty<JTable, String> jTableBeanProperty_2 = BeanProperty
				.create("selectedElement.description");
		BeanProperty<Testimony, String> testimonyBeanProperty_6 = BeanProperty
				.create("description");
		AutoBinding<JTable, String, Testimony, String> autoBinding_2 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE, table,
						jTableBeanProperty_2, testimonySelected,
						testimonyBeanProperty_6);
		autoBinding_2.bind();
		//
		BeanProperty<JTextField, String> jTextFieldBeanProperty = BeanProperty
				.create("text");
		AutoBinding<Testimony, Integer, JTextField, String> autoBinding_3 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE,
						testimonySelected, testimonyBeanProperty_4,
						testimonyId, jTextFieldBeanProperty);
		autoBinding_3.bind();
		//
		BeanProperty<JTextField, String> jTextFieldBeanProperty_1 = BeanProperty
				.create("text");
		AutoBinding<Testimony, String, JTextField, String> autoBinding_4 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE,
						testimonySelected, testimonyBeanProperty_5, title,
						jTextFieldBeanProperty_1);
		autoBinding_4.bind();
		//
		BeanProperty<JTextPane, String> jTextPaneBeanProperty = BeanProperty
				.create("text");
		AutoBinding<Testimony, String, JTextPane, String> autoBinding_5 = Bindings
				.createAutoBinding(UpdateStrategy.READ_WRITE,
						testimonySelected, testimonyBeanProperty_6,
						description, jTextPaneBeanProperty);
		autoBinding_5.bind();
	}
}
