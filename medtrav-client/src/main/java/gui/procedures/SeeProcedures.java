...
public class SeeProcedures extends JFrame {
	...
	public SeeProcedures() {
		setTitle("See all the procedures");
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				SeeProcedures.this.setVisible(false);
			}
		});
		button.setIcon(new ImageIcon(SeeProcedures.class
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(panel, GroupLayout.DEFAULT_SIZE, 615, Short.MAX_VALUE))
