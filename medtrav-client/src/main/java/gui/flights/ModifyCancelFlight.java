...
public class ModifyCancelFlight extends JFrame {
	...
	public ModifyCancelFlight() {
		...
		buttonHome.setIcon(new ImageIcon(ModifyCancelFlight.class.getResource("/images/blue-home-icon.png")));
		...
		btnUpdate.setIcon(new ImageIcon(ModifyCancelFlight.class.getResource("/images/updateFlight.png")));
		...
		btnCancel.setIcon(new ImageIcon(ModifyCancelFlight.class.getResource("/images/deleteFlight.png")));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addContainerGap()
							.addComponent(panel_1, GroupLayout.PREFERRED_SIZE, 775, Short.MAX_VALUE))
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGap(10)
							.addComponent(labelLogo)
							.addGap(86)
							.addComponent(lblModifyCancel, GroupLayout.PREFERRED_SIZE, 339, GroupLayout.PREFERRED_SIZE)
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblModifyCancel, GroupLayout.PREFERRED_SIZE, 96, GroupLayout.PREFERRED_SIZE))
