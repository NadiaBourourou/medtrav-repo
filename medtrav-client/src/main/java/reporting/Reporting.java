...
public class Reporting {
	...
	public static void main(String[] args) throws FileNotFoundException,
		...
		TextFieldBuilder<String> title = DynamicReports.cmp
				.text("Hotels : Partners of MedTrav .");
		...
		// add tables
		// add columns
		TextColumnBuilder<String> NameColumn = Columns.column("Hotel", "name",
				DynamicReports.type.stringType());
		TextColumnBuilder<String> DescriptionColumn = Columns.column(
				"Hotel description", "description",
				DynamicReports.type.stringType());
		TextColumnBuilder<String> AddressColumn = Columns.column("Address",
				"address", DynamicReports.type.stringType());
		TextColumnBuilder<Integer> starsColumn = Columns.column("* * * ",
				"stars", DynamicReports.type.integerType());
		TextColumnBuilder<Double> PriceSRColumn = Columns.column(
				"Single Room $ ", "priceSingle",
				DynamicReports.type.doubleType());
		TextColumnBuilder<Double> PriceSuiteColumn = Columns.column("Suite $ ",
				"priceSuite", DynamicReports.type.doubleType());
		...
		// add columns
		report.columns(rowNumColumn, NameColumn, DescriptionColumn,
				AddressColumn, starsColumn, PriceSRColumn, PriceSuiteColumn);
