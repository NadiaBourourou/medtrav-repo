...
public class Booking extends JFrame {
	...
	public Booking() {
		...
		label.setIcon(new ImageIcon(Booking.class.getResource("/images/hotel-service_318-29285.jpg")));
		...
		label_1.setIcon(new ImageIcon(Booking.class.getResource("/images/hospital_medicine_health_healthcare_medical-512.png")));
		...
		label_2.setIcon(new ImageIcon(Booking.class.getResource("/images/operating-room-theatre-256.png")));
		...
		label_3.setIcon(new ImageIcon(Booking.class.getResource("/images/Flight_icon.png")));
		...
		label_4.setIcon(new ImageIcon(Booking.class.getResource("/images/doctorb.png")));
		...
		btnBook.setIcon(new ImageIcon(Booking.class.getResource("/images/book-now-icon.png")));
		btnBook.setBounds(507, 207, 86, 85);
		contentPane.add(btnBook);
		
		JButton button = new JButton("");
		button.setIcon(new ImageIcon(Booking.class.getResource("/images/d\u00E9tails.jpg")));
	...
	protected void initDataBindings() {
		...
		AutoBinding<Hotel, Hotel, JTextField, JTextField> autoBinding = Bindings.createAutoBinding(UpdateStrategy.READ_WRITE, hotel, thotel, jTextFieldObjectProperty);
		autoBinding.bind();
	}
}
